...
import {
    ArrowLeft, Upload, Trash2, BookOpen, User, Building, Calendar, Hash,
    FileText, Languages, Tag
} from 'lucide-react';
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center">
                                                <User size={16} className="text-gray-500 absolute ml-3" />
                                                <input
                                                    type="text"
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <div className="flex items-center">
                                                    <Hash size={16} className="text-gray-500 absolute ml-3" />
                                                    <input
                                                        type="text"
                                                        className="w-full p-3 pl-10 border border-gray-300 rounded-lg"
                                                    />
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center">
                                                    <Building size={16} className="text-gray-500 absolute ml-3" />
                                                    <input
                                                        type="text"
                                                        className="w-full p-3 pl-10 border border-gray-300 rounded-lg"
                                                    />
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <div>
                                                ...
                                                <div className="flex items-center">
                                                    <Calendar size={16} className="text-gray-500 absolute ml-3" />
                                                    <input
                                                        type="date"
                                                        className="w-full p-3 pl-10 border border-gray-300 rounded-lg"
                                                    />
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center">
                                                    <FileText size={16} className="text-gray-500 absolute ml-3" />
                                                    <input
                                                        type="number"
                                                        className="w-full p-3 pl-10 border border-gray-300 rounded-lg"
                                                    />
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center">
                                                    <Languages size={16} className="text-gray-500 absolute ml-3" />
                                                    <input
                                                        type="text"
                                                        className="w-full p-3 pl-10 border border-gray-300 rounded-lg"
                                                    />
