        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 mb-16">
          ...
          <div className="flex flex-col justify-between flex-grow">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                className="bg-gray-800 hover:bg-gray-700 py-3 px-8 rounded-xl flex items-center gap-2 font-medium transition-all duration-200 shadow-lg hover:-translate-y-0.5"
