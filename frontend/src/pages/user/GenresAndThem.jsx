        ...
        <div className='mb-12'>
          <div className='flex justify-between items-center text-white mb-11'>
            ...
            <div className='flex items-center gap-2 group cursor-pointer'>
              <Link
                to='/allbooks'
                className='text-white text-lg underline group-hover:text-[#0077ff] transition-colors'
              >
                See All
              </Link>
              <svg
              ...
              >
                <div className='w-full'>
                  <div className='relative overflow-hidden rounded shadow-lg'>
                    ...
                    />
                    <p
                      className={`m-0 px-3 py-1 inline-flex items-center justify-center text-white text-xs font-medium absolute bottom-2 left-2 z-10 rounded ${
