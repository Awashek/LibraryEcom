...
export default function UserManagement() {
  const [users, setUsers] = useState([
    { id: 1, firstName: 'John', lastName: 'Doe', email: 'john.doe@example.com', role: 'Member' },
    { id: 2, firstName: 'Jane', lastName: 'Smith', email: 'jane.smith@example.com', role: 'Staff' },
    { id: 3, firstName: 'Robert', lastName: 'Johnson', email: 'robert.j@example.com', role: 'Member' },
    { id: 4, firstName: 'Emily', lastName: 'Williams', email: 'emily.w@example.com', role: 'Staff' },
    { id: 5, firstName: 'Michael', lastName: 'Brown', email: 'michael.b@example.com', role: 'Member' },
  ]);
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-6 border border-gray-200">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex flex-col w-full sm:w-auto">
                  <label className="mb-1 text-sm text-gray-500">User Role</label>
                  <select
                    value={roleFilter}
