    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-cover bg-center"
            ...
            <div className="bg-white overflow-hidden max-w-3xl w-full p-12 shadow-xl rounded-lg relative">
                {/* Removed the rounded-full overlay since we're using rounded-lg on parent */}
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 gap-6">
                            ...
                            <div className="text-center text-sm text-gray-600">
                                Already have an account? <Link to="/login" className="font-medium hover:underline cursor-pointer">Sign In</Link>
                            </div>
                        </div>
                    </form>
                </div>
