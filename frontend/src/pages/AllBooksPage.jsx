    ...
    const allBooks = [
        {
            ...
            coverImage: "https://m.media-amazon.com/images/I/91xWXZRx2hL._UF894,1000_QL80_.jpg",
            status: "Available"
        },
        {
            id: 2,
            ...
            author: "J K Rowling",
            coverImage: "https://images.justwatch.com/poster/87608067/s718/harry-potter-and-the-philosophers-stone.jpg",
            status: "Available"
        },
        {
            id: 3,
        ...
        },
        {
            ...
            author: "John Green",
            coverImage: "https://m.media-amazon.com/images/M/MV5BYTA4ODg5YWUtYmZiYy00Y2M4LWE0NjEtODE5MzhkYmJmZGEwXkEyXkFqcGc@._V1_.jpg",
            status: "Booked"
        },
        {
            id: 5,
            ...
            coverImage: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQVhs0zWJkL9afwN2gqJJ3vtmX4yJVAeZchddbahTVkHzCi9fyKtXwj0OEcznWUsFRn_VKd",
            status: "Booked"
        },
        {
            id: 6,
                    ...
                    {currentBooks.map((book) => (
                        <div key={book.id} className="flex flex-col">
                            <div className="relative pb-[150%] overflow-hidden">
                                ...
                                <div className={`absolute bottom-0 left-0 px-2 py-1 m-2 text-xs font-medium ${book.status === 'Available' ? 'bg-green-600' : 'bg-red-600'
                                    }`}>
                                    {book.status}
                                </div>
                            </div>
