...
const recentOrders = [
    { id: '1234', member: 'John Smith', book: 'The Great Gatsby', status: 'Ready for pickup', date: '2025-05-02' },
    { id: '1235', member: 'Emma Wilson', book: 'To Kill a Mockingbird', status: 'Processing', date: '2025-05-02' },
    { id: '1236', member: 'Michael Brown', book: '1984', status: 'Ready for pickup', date: '2025-05-01' },
    { id: '1237', member: 'Sophia Davis', book: 'Pride and Prejudice', status: 'Picked up', date: '2025-05-01' },
    { id: '1238', member: 'James Johnson', book: 'The Hobbit', status: 'Processing', date: '2025-04-30' },
];

const popularBooks = [
    { title: 'Dune', author: 'Frank Herbert', orders: 28, available: 5 },
    { title: 'The Lord of the Rings', author: 'J.R.R. Tolkien', orders: 24, available: 3 },
    { title: 'Harry Potter Series', author: 'J.K. Rowling', orders: 22, available: 8 },
    { title: 'A Song of Ice and Fire', author: 'George R.R. Martin', orders: 19, available: 2 },
];
...
const bookReviews = [
    {
        ...
        review: 'An absolutely captivating read that makes you think about the choices we make in life.',
        rating: 5,
        date: '2025-05-01'
    },
    {
        ...
        review: 'Incredible sci-fi that balances technical details with heart. Couldn\'t put it down!',
        rating: 5,
        date: '2025-04-29'
    },
    {
        ...
        userName: 'Marcus Lee',
        review: 'A poignant exploration of artificial intelligence and what it means to be human.',
        rating: 4,
        date: '2025-04-28'
    },
    {
        ...
        review: 'Heartbreaking historical fiction that resonates with today\'s challenges.',
        rating: 4,
        date: '2025-04-27'
    }
];
...
function ReviewCard({ bookName, userName, review, rating, date }) {
    return (
        <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow transition-shadow duration-300">
            ...
            <p className="text-gray-600 text-sm mb-3 overflow-hidden text-ellipsis" style={{ display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical" }}>{review}</p>
